...
{
    public class FileTransportService : grpcFileTransportServer.FileService.FileServiceBase
    {
        ...
        public override async Task<Empty> FileUpload(IAsyncStreamReader<BytesContent> requestStream,
